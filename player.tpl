...
width: 100%;
    ...
    <div class="container" align="center">
      <div class="grids" >
        <div class="main">
            <table cellpadding="0" border="0" cellspacing="0" bgcolor = "#c4f0fc">
                <tr>
                    <td>
                        <a href="/previous"><img alt="" src="images/playprevpausenext_0_0.png" style="width:196px; height: 155px; border-width: 0px" name="0_0"
                            onmouseout="exchange(this,
                            'images_playprevpausenext', 0);"
                            onmouseover="exchange(this,
                            'images_playprevpausenext', 1);"/></a>
                    </td>
                    <td>
                        <a href="/play"><img alt="" src="images/playprevpausenext_0_1.png"
                            style="width: 124px; height: 155px; border-width: 0px" name="0_1"
                    ...
                    <td><a href="/pause"><img alt="" src="images/playprevpausenext_0_2.png"
                        style="width: 123px; height: 155px; border-width: 0px" name="0_2"
                        onmouseout="exchange(this, 'images_playprevpausenext', 0);"
                        onmouseover="exchange(this, 'images_playprevpausenext', 1);"
                        /></a></td>
                    <td><a href="/next"><img alt="" src="images/playprevpausenext_0_3.png"
                        style="width: 199px; height: 155px; border-width: 0px" name="0_3"
                        onmouseout="exchange(this, 'images_playprevpausenext', 0);"
                        onmouseover="exchange(this, 'images_playprevpausenext', 1);"
                        /></a></td>
                </tr>
                    ...
                    <td align = "center">
                        ...
                        <form
                            ...
                            URI: <input name="URI" type="text"
                                size="30" placeholder="address to file or stream"/>
                            <input value="Play"
                                type="submit" />
                        </form>
                        <br>
                ...
                <tr>
                    <td width="300"
                        ...
                        <ul>
                            ...
                            <li><a href="/fav/{{fav}}">{{titles[fav-1]}}</a>
                               - <a href="/setfav/{{fav}}">Set</a></li>
                            %end
                            <li><a href="/addfav">Add Favorite</a><br><br>
                            </li>
                        </ul>
                    </td>
                    <td valign="top">
                        ...
                        <ul>
                            %for i in range(0,len(podcasts)):
                            <form
                                action="/playPodcast" name="postlink_{{i}}" method="post"><input
                                type="hidden" name="feed_url" value="{{podcasts[i][1]}}"></form>
                            <li>  <a href=# onclick="submitPostLink_{{i}}(); return
                                false;">{{podcasts[i][0]}}</a></li>
                            %end
                            <form
                                action="/addPodcast" method="post">
                                <li>Add: <input
                                    name="feed_url" type="text" placeholder = "RSS feed address"/>
            ...
            <table
                ...
                <tr>
                    <td><img alt=""
                        src="images/vol_0_0.png" style="width: 63px; height: 98px;
                        border-width: 0px" name="0_0"/>
                    </td>
                    <td><a href="/vol/25"><img alt="" src="images/vol_0_1.png"
                        style="width:41px; height: 98px; border-width: 0px" name="0_1"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);"/></a>
                    </td>
                    ...
                    <td><a href="/vol/35"><img alt="" src="images/vol_0_3.png" style="width:
                        42px; height: 98px; border-width: 0px" name="0_3"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);"/></a></td>
                    <td><a href="/vol/40"><img alt="" src="images/vol_0_4.png" style="width:
                        41px; height: 98px; border-width: 0px" name="0_4"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this,
                        'images_vol', 1);"/></a>
                    </td>
                    <td><a href="/vol/45"><img alt="" src="images/vol_0_5.png" style="width:
                        42px; height: 98px; border-width: 0px" name="0_5"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);"/></a></td>
                    ...
                    <td><a href="/vol/80"><img alt="" src="images/vol_0_12.png" style="width:
                        42px; height: 98px; border-width: 0px" name="0_12"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);" /></a>
                    </td>
                    <td><a href="/vol/85"><img alt="" src="images/vol_0_13.png"
                        style="width:42px; height: 98px; border-width: 0px" name="0_13"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);"/></a>
                    </td>
                    <td><a href="/vol/90"><img alt="" src="images/vol_0_14.png"
                        style="width:34px; height: 98px; border-width: 0px" name="0_14"
                        onmouseout="exchange(this, 'images_vol', 0);"
                        onmouseover="exchange(this, 'images_vol', 1);"/></a>
                    </td>
                </tr>
            ...
            <table width = "642" bgcolor = "#eeeeee">
                <tr>
                    <td><br></td>
                    <td class="foot" align = "right"><a
                        href="https://github.com/tilltnet/rf.wr.py/blob/master/LICENSE">License /
                        GPL</a> - <a
                            href="https://github.com/tilltnet/rf.wr.py">github</a>
                    </td>
                </tr>
            </table>
        </div>
      ...
      <div class="grids">
        ...
        <div class="main">
            %for fav in range(0,len(cover_imgs)):
                <div class = "cover" style="background-image: url({{cover_imgs[fav]}}); background-size: 157px 157px; height: 157px; width: 157px">
                  <a href="/fav/{{fav+1}}"><span></span></a>
                  <br><br><br><br><br><br><br><br>
                  <div class="cover_text">
                    <a href="/fav/{{fav+1}}">{{titles[fav]}}</a>
                    -<a href="/setfav/{{fav+1}}">&nbsp;Set&nbsp;</a>
                  </div>
                </div>
            %end
            <div class = "cover" style="background-image: url('/images/add_Favorite.png'); background-size: 157px 157px; height: 157px; width: 157px">
              <a href="/addfav"><span></span></a><br><br><br><br><br><br><br><br>
              <div class="cover_text">
                <a href="/addfav">Add Favorite</a></div>
            </div>
        </div>
        <div class="main">
          ...
          %for i in range(0,len(podcasts)):
          <div class = "cover" style="background-image: url({{urllib.quote(podcasts[i][2], ':/')}}); background-size: 157px 157px; height: 157px; width: 157px">
          <form
              action="/playPodcast" name="postlink_{{i}}" method="post"><input
              type="hidden" name="feed_url" value="{{podcasts[i][1]}}"></form>
            <a href=# onclick="submitPostLink_{{i}}(); return
              false;"><span></span></a>
            <br><br><br><br><br><br><br><br>
            <div class="cover_text">
            <a href=# onclick="submitPostLink_{{i}}(); return
